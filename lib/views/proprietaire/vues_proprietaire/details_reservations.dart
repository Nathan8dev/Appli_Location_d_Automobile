...
import 'detail_automobile.dart'; // Pour réutiliser buildVehicleImage et naviguer vers les détails du véhicule
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              value,
              style: TextStyle(fontSize: 16, color: color ?? Colors.black87, fontWeight: isBold ? FontWeight.bold : FontWeight.normal),
            ),
          ),
        ],
      ),
